...
call <sid>hi("MoreMsg",       s:gui08, "", s:cterm08, "", "", "")
...
" Git highlighting
" The commit message when the message is to long
...
" The branch name itself not the comment
call <sid>hi("gitcommitBranch",         s:gui0A, "", s:cterm0B, "", "", "")
call <sid>hi("gitcommitUntrackedFile",  s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("gitcommitUnmergedFile",   s:gui08, "", s:cterm08, "", "", "")
" Files modified but not committed
call <sid>hi("gitcommitDiscardedFile",  s:gui0E, "", s:cterm0E, "", "", "")
" Files under Changes to be committed
call <sid>hi("gitcommitSelectedFile",   s:gui0E, "", s:cterm0E, "", "", "")
